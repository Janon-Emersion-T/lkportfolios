...
<head>
    ...
    <meta property="og:url" content="https://lkportfolios.com/privacy-policy">
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="https://lkportfolios.com/privacy-policy">
</head>
    ...
    <main class="">
        <div class="bg-sky-950 py-10 md:pt-32 px-6">
            ...
            <nav class="flex items-left text-sm text-gray-400 mt-4">
                ...
                <a href="{{ route('privacy_policy') }}" class="hover:text-white"><?php print($meta_title) ?></a>
            </nav>
        </div>
