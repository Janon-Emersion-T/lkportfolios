...
@endphp{{-- recommendation Details View --}}
        ...
        <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden">
            ...
            <div class="border-b border-gray-700 p-6">
                <div class="flex justify-between items-center">
                    <h1 class="text-2xl font-bold text-white">recommendation Details</h1>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <section class="space-y-6">
                        <div class="space-y-1">
                            <h3 class="text-sm font-medium text-gray-400">Recommender</h3>
                            <p class="text-lg font-medium text-white">{{ $recommendation->recommender }}</p>
                        </div>
                        
                        <div class="space-y-1">
                            <h3 class="text-sm font-medium text-gray-400">Relationship</h3>
                            <p class="text-lg font-medium text-white">{{ $recommendation->relationship }}</p>
                        </div>
                        
                        <div class="space-y-1">
                            <h3 class="text-sm font-medium text-gray-400">Description</h3>
                            <p class="text-lg font-medium text-white">{{ $recommendation->description}}</p>
                        </div>
                    ...
                    <section class="md:col-span-2 space-y-6">
                        ...
                        <div class="space-y-1">
                            <h3 class="text-sm font-medium text-gray-400">Description</h3>
                            <p class="text-lg font-medium text-white">{{ $recommendation->description ?: 'No description provided' }}</p>
                        </div>
                    </section>
                    ...
                    <section class="md:col-span-2 border-t border-gray-700 pt-6 mt-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            <div>
                                ...
                                <span class="text-white ml-2">{{ $recommendation->add_to_cv ? 'Yes' : 'No' }}</span>
                            </div>
                            <div>
                                <span class="text-gray-400">Added:</span>
                                <span class="text-white ml-2">{{ $recommendation->date_created->format('M d, Y') }}</span>
                            </div>
                            <div>
                                <span class="text-gray-400">Last Updated:</span>
                                <span class="text-white ml-2">{{ $recommendation->date_updated->format('M d, Y') }}</span>
                            </div>
                        </div>
                    </section>
                </div>
