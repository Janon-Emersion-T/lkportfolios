        ...
        <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden">
            ...
            <div class="border-b border-gray-700 p-6">
                <div class="flex justify-between items-center">
                    <h1 class="text-2xl font-bold text-white">volunteer Details</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <section class="space-y-6">
                        <div class="space-y-1">
                            ...
                            <p class="text-lg font-medium text-white">{{ $volunteer->organization }}</p>
                        </div>
                        
                        <div class="space-y-1">
                            <h3 class="text-sm font-medium text-gray-400">Role</h3>
                            <p class="text-lg font-medium text-white">{{ $volunteer->role }}</p>
                        </div>
                        
                        <div class="space-y-1">
                            <h3 class="text-sm font-medium text-gray-400">Cause</h3>
                            <p class="text-lg font-medium text-white">{{ $volunteer->cause }}</p>
                        </div>
                        
                        <div class="space-y-1">
                            <h3 class="text-sm font-medium text-gray-400">Location</h3>
                            <p class="text-lg font-medium text-white">{{ $volunteer->location }}</p>
                        </div>
                    </section>
                    ...
                    <section class="space-y-6">
                         <div class="space-y-1">
                                ...
                                <p class="text-lg font-medium text-white">
                                    {{ $months[$volunteer->start_month] ?? '' }} {{ $volunteer->start_year }}
                                </p>
                            </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-lg font-medium text-white">
                                    {{ $months[$volunteer->end_month] ?? '' }} {{ $volunteer->end_year }}
                                </p>
                            </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-lg font-medium text-white">
                                <span class="{{ $volunteer->is_current ? 'text-green-400' : 'text-gray-400' }}">
                                    {{ $volunteer->is_current ? 'Currently Studying' : 'Completed' }}
                                </span>
                            </p>
                        </div>
                    </section>
                    ...
                    <section class="md:col-span-2 space-y-6">
                        <div class="space-y-1">
                            ...
                            <p class="text-lg font-medium text-white">{{ $volunteer->activities ?: 'No activities listed' }}</p>
                        </div>
                        
                        <div class="space-y-1">
                            <h3 class="text-sm font-medium text-gray-400">Description</h3>
                            <p class="text-lg font-medium text-white">{{ $volunteer->description ?: 'No description provided' }}</p>
                        </div>
                    </section>
                    ...
                    <section class="md:col-span-2 border-t border-gray-700 pt-6 mt-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            <div>
                                ...
                                <span class="text-white ml-2">{{ $volunteer->add_to_cv ? 'Yes' : 'No' }}</span>
                            </div>
                            <div>
                                <span class="text-gray-400">Added:</span>
                                <span class="text-white ml-2">{{ $volunteer->date_created->format('M d, Y') }}</span>
                            </div>
                            <div>
                                <span class="text-gray-400">Last Updated:</span>
                                <span class="text-white ml-2">{{ $volunteer->date_updated->format('M d, Y') }}</span>
                            </div>
                        </div>
                    </section>
                </div>
