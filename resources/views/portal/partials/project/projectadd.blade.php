...
<div class="min-h-screen flex bg-gray-50 dark:bg-gray-900">
    ...
    <div class="w-full pt-24 xl:pl-72 lg:pl-72 sm:pl-4">
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Enter the details of your new project below.</p>
        </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
                <form action="{{ route('project.store') }}" method="POST">
                    ...
                    <div class="mt-6 flex justify-end space-x-4">
                        <a href="{{ route('project.index') }}" class="px-6 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600">
                            Cancel
                        </a>
