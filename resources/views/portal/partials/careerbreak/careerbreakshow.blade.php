...
@endphp{{-- careerbreak Details View --}}
        ...
        <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden">
            ...
            <div class="border-b border-gray-700 p-6">
                <div class="flex justify-between items-center">
                    <h1 class="text-2xl font-bold text-white">careerbreak Details</h1>
                    <div class="flex space-x-4">
                        <a href="{{ route('careerbreak.index') }}" 
                        ...
                        <a href="{{ route('careerbreak.edit', $careerbreak->id) }}" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <section class="space-y-6">
                        <div class="space-y-1">
                            ...
                            <p class="text-lg font-medium text-white">{{ $careerbreak->type }}</p>
                        </div>
                        
                        <div class="space-y-1">
                            <h3 class="text-sm font-medium text-gray-400">location</h3>
                            <p class="text-lg font-medium text-white">{{ $careerbreak->location }}</p>
                        </div>
                        
                        <div class="space-y-1">
                            <h3 class="text-sm font-medium text-gray-400">Grade</h3>
                            <p class="text-lg font-medium text-white">{{ $careerbreak->grade }}</p>
                        </div>
                    </section>
                    ...
                    <section class="space-y-6">
                         <div class="space-y-1">
                                ...
                                <p class="text-lg font-medium text-white">
                                    {{ $months[$careerbreak->start_month] ?? '' }} {{ $careerbreak->start_year }}
                                </p>
                            </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-lg font-medium text-white">
                                    {{ $months[$careerbreak->end_month] ?? '' }} {{ $careerbreak->end_year }}
                                </p>
                            </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-lg font-medium text-white">
                                <span class="{{ $careerbreak->is_current ? 'text-green-400' : 'text-gray-400' }}">
                                    {{ $careerbreak->is_current ? 'Currently Studying' : 'Completed' }}
                                </span>
                            </p>
                        </div>
                    </section>
                    ...
                    <section class="md:col-span-2 space-y-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-lg font-medium text-white">{{ $careerbreak->description ?: 'No description provided' }}</p>
                        </div>
                    </section>
                    ...
                    <section class="md:col-span-2 border-t border-gray-700 pt-6 mt-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            <div>
                                ...
                                <span class="text-white ml-2">{{ $careerbreak->add_to_cv ? 'Yes' : 'No' }}</span>
                            </div>
                            <div>
                                <span class="text-gray-400">Added:</span>
                                <span class="text-white ml-2">{{ $careerbreak->created_at->format('M d, Y') }}</span>
                            </div>
                            <div>
                                <span class="text-gray-400">Last Updated:</span>
                                <span class="text-white ml-2">{{ $careerbreak->updated_at->format('M d, Y') }}</span>
                            </div>
                        </div>
                    </section>
                </div>
