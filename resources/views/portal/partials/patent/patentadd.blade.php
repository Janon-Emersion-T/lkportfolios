...
<div class="min-h-screen flex bg-gray-50 dark:bg-gray-900">
    ...
    <div class="w-full pt-24 xl:pl-72 lg:pl-72 sm:pl-4">
        <div class="px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Add patent</h1>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Enter the details of your new patent below.</p>
        </div>
                ...
                <form action="{{ route('patent.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="patent_application_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Patent Application Number</label>
                                <input type="text" name="patent_application_number" id="patent_application_number" value="{{ old('patent_application_number') }}" required class="mt-1 block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-blue-500 focus:border-blue-500">
                                @error('patent_application_number')
                                <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select name="status" id="status"  required class="mt-1 block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    <option value="Granted" {{ old('status') == 'Granted' ? 'selected' : '' }}>Granted</option>
                             ...
                             <div>
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="date" name="issue_date" id="issue_date" value="{{ old('issue_date') }}" required class="mt-1 block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-blue-500 focus:border-blue-500" max="{{ \Carbon\Carbon::now()->toDateString() }}">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-6 flex justify-end space-x-4">
                        <a href="{{ route('patent.index') }}" class="px-6 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600">
                            Cancel
                        </a>
